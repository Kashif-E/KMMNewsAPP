...
import com.kashif.kmmnewsapp.core.di.headlinesModule
...
fun networkModule() = module {
    ...
    single<NetworkConnectivityServiceImpl> { get<NetworkConnectivityService>() as NetworkConnectivityServiceImpl }
}
